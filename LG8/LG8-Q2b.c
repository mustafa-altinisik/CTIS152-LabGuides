...
void deleteAllOccur(char *sentence, char *given);
...
int main()
{
    ...
    {
        deleteAllOccur(sentence, given);
        printf("\nNew version of the sentence after deletion:\n%s\n", sentence);
...
void
deleteAllOccur(char *sentence, char *given)
{
    int position = findFirst(sentence, given);
    ...
    while(position != -1)
    {
        ...
        position = findFirst(sentence, given);
